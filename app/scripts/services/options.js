  ...
  Options = class Options {
    static initClass() {
      ...
      this.THEMES = (function() {
        ...
        // bootswatch themes
        for (let name of ['cerulean', 'cosmo', 'cyborg', 'darkly', 'flatly', 'journal', 'lumen', 'paper', 'readable', 'sandstone', 'simplex', 'slate', 'spacelab', 'superhero', 'united', 'yeti']) {
          ret.list.push({
            name,
            label: name,
    ...
    fpsAuto(enabled) {
      ...
      return this.get('fpsAuto', (this.get('fps') == null));
    }
