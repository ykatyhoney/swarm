...
return Game = (function() {
  Game = class Game {
    ...
    getNewlyUpgradableUnits() {
      return (() => {
        const result = [];
        for (let u of Array.from(this.unitlist())) {           if (u.isNewlyUpgradable() && u.isVisible()) {
            result.push(u);
          }
        }
        return result;
    ...
    availableUpgrades(costPercent) {
      ...
      return (() => {
        const result = [];
        for (let u of Array.from(this.upgradelist())) {           if (u.isVisible() && u.isUpgradable(costPercent, true)) {
            result.push(u);
          }
        }
        return result;
    ...
    availableAutobuyUpgrades(costPercent) {
      ...
      return (() => {
        const result = [];
        for (let u of Array.from(this.availableUpgrades(costPercent))) {           if (u.isAutobuyable()) {
            result.push(u);
          }
        }
        return result;
    ...
    ignoredUpgrades() {
      return (() => {
        const result = [];
        for (let u of Array.from(this.upgradelist())) {           if (u.isVisible() && u.isIgnored()) {
            result.push(u);
          }
        }
        return result;
    ...
    reset(transient) {
      ...
      this.session.reset();
      this._init();
      for (let unit of Array.from(this.unitlist())) {
    ...
    ascend(free) {
      ...
      return this.withSave(() => {
        ...
        return (() => {
          const result = [];
          for (let upgrade of Array.from(this.upgradelist())) {
    ...
    respecSpent() {
      ...
      const ignores = {};
      for (let up of Array.from(mutagen.upgrades.list)) {
    ...
    _respec() {
      ...
      for (let resource of Array.from(mutagen.spentResources())) {
